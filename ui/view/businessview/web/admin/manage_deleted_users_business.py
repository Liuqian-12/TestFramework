...
class Manage_deleted_users_business(BusinessWebPage):
    ...
    def get_search_input_exist_user(self):
        return self.find_element(*self._page.exist_user).is_displayed()

    def get_search_input_not_exist_user(self):
        return self.find_element(*self._page.not_exist_user).is_displayed()
